...
for i in range(len(light_T)):
    ...
    # Define RGB wavelength ranges (in nm)
    # R: 620-780 nm, G: 495-570 nm, B: 380-495 nm
    wavelength_ranges = [(645, 655), (545, 555), (445, 455)]

    # Create wavelength array (381-780 nm, matching reflected_intensity's spectral dimension)
    ...
    plt.imshow(rgba)
    plt.axis('off')  # 隐藏坐标轴
    output_dir = data_path('Figure1/regular')
